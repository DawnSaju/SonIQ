...
flowchart TB
    ...
    classDef binary fill:#2c2c2e,stroke:#48484a,stroke-width:1.5px,color:#ffffff,rx:8,ry:8
    ...
    subgraph Binaries["Bundled macOS Binaries"]
        FFmpeg["FFmpeg"]
    ...
    class Cmd,Async,Extract,Fingerprint,Match backend;
    class FFmpeg,Fpcalc binary;
...
<a href="https://github.com/DawnSaju/SonIQ/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=DawnSaju/SonIQ" alt="Developer" />
</a>
